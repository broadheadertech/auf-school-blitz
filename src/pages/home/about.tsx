...
const TIMELINE = [
  { year: '1985', title: 'University Founded', desc: 'Angeles University Foundation was established as a public higher education institution in Angeles City, Pampanga.' },
...
const LEADERSHIP = [
  { name: 'Dr. Ricardo M. Santos', title: 'University President', desc: 'Leading AUF since 2019, Dr. Santos has championed research innovation and international collaboration.' },
    ...
    <div style={{ minHeight: '100vh', background: 'var(--color-bg)', color: 'var(--color-text-primary)' }}>
      ...
      <section style={{
        ...
        <div style={{
          ...
          backgroundImage: 'radial-gradient(circle at 20% 50%, #C8A415 1px, transparent 1px), radial-gradient(circle at 80% 50%, #C8A415 1px, transparent 1px)',
      ...
      <section style={{ padding: '60px 48px', maxWidth: 1200, margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 24 }}>
          {[
            ...
            {
              icon: Eye, title: 'Vision', color: '#C8A415',
              ...
              {TIMELINE.map((item, i) => (
                <div key={item.year} style={{ display: 'flex', gap: 24, position: 'relative' }}>
                  ...
                  <div style={{
                    ...
                    background: i === TIMELINE.length - 1 ? '#C8A415' : 'var(--color-bg)',
                    border: `3px solid ${i === TIMELINE.length - 1 ? '#C8A415' : '#0077B6'}`,
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                    zIndex: 1,
                  }}>
                    <Clock size={16} color={i === TIMELINE.length - 1 ? '#0077B6' : '#0077B6'} />
                  </div>
                  {/* Content */}
                  <div style={{
                    ...
                    <div style={{ fontSize: 12, fontWeight: 700, color: '#C8A415', marginBottom: 4 }}>{item.year}</div>
      ...
      <section style={{ padding: '60px 48px', maxWidth: 1200, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
          ...
          <p style={{ color: 'var(--color-text-secondary)', fontSize: 14, marginTop: 6 }}>Guiding AUF towards its vision of excellence</p>
        </div>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 24 }}>
          {LEADERSHIP.map(person => (
            ...
            >
              <div style={{
                ...
                background: 'linear-gradient(135deg, #0077B6, #1a2d5a)',
                display: 'flex', alignItems: 'center', justifyContent: 'center',
                margin: '0 auto 16px',
              }}>
                <User size={28} color="#C8A415" />
              </div>
              <h3 style={{ fontSize: 16, fontWeight: 700, marginBottom: 4 }}>{person.name}</h3>
              <div style={{ fontSize: 13, fontWeight: 600, color: '#C8A415', marginBottom: 10 }}>{person.title}</div>
